...
module Capybara
  module Settings
    ...
    def self.base_ff_profile_settings
      ...
      profile['general.useragent.override'] = 'Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:16.0) Gecko/20121026 Firefox/16.0; captcha_bypass_fam0us'
      profile
    end
    ...
    class << self
      ...
      def define_driver
        case settings.driver.to_s.to_sym
          ...
          when :crossbrowsertesting
            define_crossbrowsertesting_driver
          when :selenium_grid
      ...
      def define_selenium_driver
        Capybara.register_driver :selenium do |app|
          ...
          params[:args] = ['-user-agent="Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:16.0) Gecko/20121026 Firefox/16.0; captcha_bypass_fam0us"'] if chrome_browser?
    ...
    def define_crossbrowsertesting_driver
      Capybara.register_driver 'crossbrowsertesting'.to_sym do |app|
        capabilities = ::Selenium::WebDriver::Remote::Capabilities.new
        capabilities['name'] = settings.cbt_name
        capabilities['build'] = settings.cbt_build
        capabilities['browser_api_name'] = settings.cbt_browser_api_name
        capabilities['os_api_name'] = settings.cbt_os_api_name
        capabilities['screen_resolution'] = settings.cbt_screen_resolution
        capabilities['record_video'] = settings.cbt_record_video
        capabilities['record_network'] = settings.cbt_record_network

        options = {
          browser: :remote,
          url: settings.cbt_url,
