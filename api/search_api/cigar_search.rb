...
module SearchApi
  class CigarSearch
    ...
    class << self
      ...
      def filter_by_title_from_group(group, title, filter_set = DEFAULT_FILTER_SET)
      ...
      def filter_names_from_group(group, filter_set = DEFAULT_FILTER_SET)
      ...
      def api_url(type)
        "#{Howitzer.app_api_protocol}://#{Howitzer.app_host}/#{type}"
      end
